...
/**
 * Immutable wait configuration used by the QATRA Smart Wait Engine.
 *
 * <p>The default values come from QATRA configuration and are intentionally
 * centralized so waits behave consistently across browser actions, element
 * actions, RTL checks, and custom components.</p>
 */
public final class WaitOptions {
    ...
    public static WaitOptions fromConfig() {
        ...
        return builder()
                ...
                .pollingInterval(Duration.ofMillis(Math.max(50, pollingMs)))
    ...
    public static final class Builder {
        ...
        public Builder pollingMillis(long millis) {
            return pollingInterval(Duration.ofMillis(Math.max(50, millis)));
        }
